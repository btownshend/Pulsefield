...
function info=infoinit()
  ...
  info=struct('duration',120,'velocity',127,'volume',0.5,'tempo',120,'scale',1,'key',1,'pgm',ones(1,8),'refresh',true,'cm',ChannelMap(8),'preset',0,'starttime',now,'ableton',1,'max',0,'al',Ableton('ableton.mat'),'song',[],'touchpage','','health',Health({'FE','LD','AL','MX','TO'}),'lastping',0,'pinginterval',1.0,'latency',0.0,'groupmap',GroupMap(60));
