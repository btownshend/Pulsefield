% Version of regionprops eliminating some input checks to make it run faster
function outstats = fastregionprops(varargin)
...
%   $Revision.4.2.3 $  $Date: 2011/11/09 16:49:00 $
...
elseif isnumeric(varargin{2}) || islogical(varargin{2})
    ...
    I = varargin{2};
    validateattributes(I, {'numeric','logical'},{}, mfilename, 'I', 2);
