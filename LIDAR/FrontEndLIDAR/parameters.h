...
static const int BGLONGDISTLIFE=50*30;		// If  the most distant
...
static const float VELDAMPING[]={0.80f,0.19f};	// Damping (multiplicative factor) for legvelocity when not visible (multiplied by same leg,other leg)
