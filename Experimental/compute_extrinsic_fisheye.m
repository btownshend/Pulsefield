function [omckk,Tckk,Rckk,H,x,ex,JJ] = compute_extrinsic_fisheye(x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond),
...
% Refinement:
[omckk,Tckk,Rckk,JJ] = compute_extrinsic_refine_fisheye(omckk,Tckk,x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond);
...
x = project_points_fisheye(X_kk,omckk,Tckk,fc,cc,kc,alpha_c);
