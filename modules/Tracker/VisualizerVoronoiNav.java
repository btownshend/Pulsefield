...
public class VisualizerVoronoiNav extends VisualizerNavier {
	...
	VisualizerVoronoiNav(PApplet parent, Scale scale, Synth synth) {
		super((Tracker)parent,synth);
